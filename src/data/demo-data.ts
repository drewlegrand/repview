...
export interface Opportunity {
  ...
  projectName?: string; bidDate?: string; source: string;
}
...
export const opportunities: Opportunity[] = [
  { id: 'o1', name: 'City Center Tower - Roof Replacement', accountName: 'Summit Roofing Contractors', stage: 'Quoted', value: 485000, probability: 60, closeDate: '2026-05-15', manufacturerLine: 'Carlisle SynTec', productCategory: 'Roofing', territory: 'Northeast', owner: 'Mike Torres', projectName: 'City Center Tower', bidDate: '2026-04-10', source: 'Existing Relationship' },
  { id: 'o2', name: 'Harbor Medical Campus - Skylights', accountName: 'Henderson Architecture Group', stage: 'Spec Influence', value: 320000, probability: 40, closeDate: '2026-07-20', manufacturerLine: 'VELUX Skylights', productCategory: 'Skylights', territory: 'Northeast', owner: 'Mike Torres', projectName: 'Harbor Medical Campus', source: 'Architect Spec' },
  { id: 'o3', name: 'Patriot Plaza Ph2 - Waterproofing', accountName: 'Patriot Development Corp', stage: 'Bid Submitted', value: 275000, probability: 70, closeDate: '2026-04-30', manufacturerLine: 'Tremco Roofing', productCategory: 'Waterproofing', territory: 'Mid-Atlantic', owner: 'Sarah Chen', projectName: 'Patriot Plaza Phase 2', bidDate: '2026-03-28', source: 'Developer Direct' },
  { id: 'o4', name: 'Greenfield Science Hall - Insulation', accountName: 'Greenfield University', stage: 'Budget Pricing', value: 142000, probability: 30, closeDate: '2026-08-15', manufacturerLine: 'Hunter Panels', productCategory: 'Insulation', territory: 'Northeast', owner: 'Mike Torres', projectName: 'Greenfield Science Hall', source: 'Owner Direct' },
  { id: 'o5', name: 'Metro Office Complex - Full Envelope', accountName: 'Metro General Contractors', stage: 'Negotiation', value: 890000, probability: 75, closeDate: '2026-04-20', manufacturerLine: 'Carlisle SynTec', productCategory: 'Roofing', territory: 'Northeast', owner: 'Mike Torres', projectName: 'Metro Office Complex', source: 'GC Bid Request' },
  { id: 'o6', name: 'Capital Center Reroof', accountName: 'Capital Facilities Group', stage: 'Awarded', value: 356000, probability: 95, closeDate: '2026-04-05', manufacturerLine: 'Soprema', productCategory: 'Roofing', territory: 'Mid-Atlantic', owner: 'James Wright', source: 'Existing Relationship' },
  { id: 'o7', name: 'Beacon Distribution Center - Cladding', accountName: 'Beacon Building Products', stage: 'Lead', value: 210000, probability: 15, closeDate: '2026-09-30', manufacturerLine: 'Kingspan Insulation', productCategory: 'Cladding', territory: 'Northeast', owner: 'Sarah Chen', source: 'Cold Call' },
  { id: 'o8', name: 'Atlantic WP - Cover Board Supply', accountName: 'Atlantic Waterproofing Inc', stage: 'Quoted', value: 95000, probability: 55, closeDate: '2026-05-01', manufacturerLine: 'Georgia-Pacific DensDeck', productCategory: 'Cover Boards', territory: 'Mid-Atlantic', owner: 'James Wright', source: 'Contractor Direct' },
  { id: 'o9', name: 'Skyline HQ Curtainwall Skylights', accountName: 'Skyline Glass & Glazing', stage: 'Spec Influence', value: 420000, probability: 35, closeDate: '2026-08-01', manufacturerLine: 'VELUX Skylights', productCategory: 'Skylights', territory: 'Mid-Atlantic', owner: 'Sarah Chen', source: 'Architect Referral' },
  { id: 'o10', name: 'Harbor Medical - Roofing', accountName: 'Summit Roofing Contractors', stage: 'Closed/Installed', value: 615000, probability: 100, closeDate: '2026-01-15', manufacturerLine: 'Carlisle SynTec', productCategory: 'Roofing', territory: 'Northeast', owner: 'Mike Torres', projectName: 'Harbor Medical Campus', source: 'Existing Relationship' },
  { id: 'o11', name: 'Providence Library Reroof', accountName: 'Northstar Consulting Engineers', stage: 'Lost', value: 188000, probability: 0, closeDate: '2026-02-28', manufacturerLine: 'Tremco Roofing', productCategory: 'Roofing', territory: 'Northeast', owner: 'James Wright', source: 'Consultant Spec' },
  { id: 'o12', name: 'Patriot Plaza Ph1 - Insulation', accountName: 'Patriot Development Corp', stage: 'Closed/Installed', value: 198000, probability: 100, closeDate: '2025-11-20', manufacturerLine: 'Kingspan Insulation', productCategory: 'Insulation', territory: 'Mid-Atlantic', owner: 'Sarah Chen', source: 'Developer Direct' },
];
